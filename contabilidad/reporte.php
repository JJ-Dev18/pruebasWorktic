...
if (!empty($_POST)) {
    ...
    foreach ($rows as $row) {
        ...
        $pdf->Cell(60, 5, utf8_decode($row->nombre), 1, 0, "C",0);
        $pdf->Cell(60, 5, $row->precio, 1, 0, "C",0);
        $pdf->Cell(60, 5, $row->tipo, 1, 1, "C",0);
        //  $pdf->Cell(30, 5, $row->precio, 1, 0, "C");
        // $pdf->Cell(50, 5, $row->tipo, 1, 0, "C");
